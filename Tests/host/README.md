...
| Suite | Coverage |
|---|---|
| `display_test.cpp` | F8: complete banner priority matrix, countdown and notice expiry across millis wrap, real ENROLL/RESCUE success and failure transitions, HELLO byte in display/headless builds; generated artwork freshness via `Tools/oled_bitmaps.py --check` |
